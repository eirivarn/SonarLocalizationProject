...
fft_data = pd.read_csv("../output/case_3/relative_pose_fft.csv")
tru_depth_data = pd.read_csv("../output/case_3/relative_pose_tru_depth.csv")
...
old_fft_time = pd.read_csv("../output/case_3/old_framework_case_3/image_time.csv").values.flatten()
old_fft_distance = pd.to_numeric(pd.read_csv("../output/case_3/old_framework_case_3/relative_distances.csv").values.flatten(), errors='coerce')
old_fft_pitch = pd.to_numeric(pd.read_csv("../output/case_3/old_framework_case_3/relative_pitches.csv").values.flatten(), errors='coerce')
old_fft_heading = pd.to_numeric(pd.read_csv("../output/case_3/old_framework_case_3/relative_headings.csv").values.flatten(), errors='coerce')

old_tru_depth_time = old_fft_time
old_tru_depth_distance = pd.to_numeric(pd.read_csv("../output/case_3/old_framework_case_3/TRU_depth_distances.csv").values.flatten(), errors='coerce')[:len(old_fft_time)]
old_tru_depth_pitch = pd.to_numeric(pd.read_csv("../output/case_3/old_framework_case_3/TRU_pitch.csv").values.flatten(), errors='coerce')[:len(old_fft_time)]
old_tru_depth_heading = pd.to_numeric(pd.read_csv("../output/case_3/old_framework_case_3/TRU_heading.csv").values.flatten(), errors='coerce')[:len(old_fft_time)]
